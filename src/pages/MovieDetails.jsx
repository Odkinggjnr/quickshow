  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      <div className='flex justify-center mt-20'>
        <button onClick={() => { navigate('/movies');  scrollTo(0,0)}} className='px-10 bg-primary hover:bg-primary-dull py-3 transition rounded-md cursor-pointer'>Show More</button>
      </div>
    </div>
  ) : <Loading/>
}
