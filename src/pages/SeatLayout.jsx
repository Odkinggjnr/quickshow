  ...
  return (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-10 md:pt-20">
      ...
      <div className="relative flex-1 flex flex-col items-center max-md:mt-16">
        ...
        <button onClick={() => navigate('/my-bookings')} className="flex items-center gap-1 mt-20 px-10 bg-primary hover:bg-primary-dull py-3 rounded-full text-sm transition font-medium cursor-pointer active:scale-95">Proceed to Checkout
